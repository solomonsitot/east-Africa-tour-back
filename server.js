...
app.use(
  cors({
    origin: (origin, callback) => {
      const allowedOrigins = ["http://localhost:5173","https://www.eastafricatouroperator.net","https://east-africa-tour-operator.vercel.app","https://eastafricatouroperator.com"];
